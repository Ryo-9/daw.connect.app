...
このmatrixは2026-09-15のHuman reviewで承認済みです。承認対象はdocs-only delivery contractであり、Provider、channel実装、physical persistence、mobile push、security retention、AWS resourceは別task / Human Gateで決めます。通知は未完了Taskの催促、production score、Version作成blockには使いません。

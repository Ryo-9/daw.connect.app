...
| --- | --- | --- | --- | --- | --- | --- | --- |
| LOCK-035 | CREATIVE-001-DESIGN | Codex | `docs/PRODUCT_SPEC.md`、`docs/USER_FLOW.md`、`docs/API.md`、`docs/DATABASE.md`、`docs/TESTING.md`、`docs/SCREEN_LIST.md`、`docs/DECISION_LOG.md`、`docs/TASK_QUEUE.md`、`docs/ACTIVE_TASKS.md`、`docs/LOCKS.md` | `docs/creative-001-creative-workflow-design` | 2026-09-11 | Draft PRのマージまたは作業中止 | Creative workflow docsのみ。runtime、DynamoDB physical key、AWS / Cognito / infraは対象外 |

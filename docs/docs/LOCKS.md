...
| --- | --- | --- | --- | --- | --- | --- | --- |
| LOCK-002 | fill-initial-docs | 未記入 | `README.md`、`AGENTS.md`、`docs/` | `docs/fill-initial-docs` | 2026-08-10 | PR マージまたは作業中止 | 文書のみ。実装領域は対象外 |

## 解除済みロック

| Lock ID | Task ID | 担当者 | ファイル / 領域 | 解除日 | 結果 / PR |
| --- | --- | --- | --- | --- | --- |
| LOCK-001 | initial-project-docs | 未記入 | `README.md`、`AGENTS.md`、`docs/` | 2026-08-10 | 文書作成完了。PR 未作成 |

...
| NOTIFY-001-DESIGN | 完了 | Codex | `docs/notify-001-delivery-matrix` / #45 | 2026-09-15 | SECURITY / DIRECT / ORDINARY、preset、Quiet Hours、digest / retry / privacyをdocs-onlyで具体化しmainへマージ済み。DEC-026は承認済み。Provider / runtime / physical DB / AWS / workflow未実装 |

...
| COLLAB-DATA-001 | P1 | Membership activity and notification persistence | 完了（PR #47）。Existing single-table / ScopeIndexを維持し、Activity / Preference / QuietHours / Notification / delivery tracking、TTL、dedup、Membership removal境界を承認済みDEC-027としてdocs-only設計。Resource / runtime未実装 |
| NOTIFY-001-DESIGN | P1 | Notification event / channel delivery matrix | 完了（PR #45）。SECURITY / DIRECT / ORDINARY、preset、Quiet Hours、digest / retry / dedup、privacy / recipient lifecycleを承認済みDEC-026としてdocs-only設計。Provider / physical DB / runtime / resourceは未実装 |

...
| --- | --- | --- | --- |
| DATA-001 | P1 | Mock data schema review | 作業中。Phase 1の実装事実とPhase 2 cloud data model候補を分け、entity、関係、enum、画面対応を文書化する |
